...
This panic structure ensures that the compiler always knows when a panic can happen and generates appropriate code.
...
And since rust cannot those errors, we cannot model them either.
