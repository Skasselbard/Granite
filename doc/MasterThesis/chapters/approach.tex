...
\lstset{language=Rust,caption={A simple function call},label=endless-program, frame=none, stepnumber=5, backgroundcolor=\color{verylightgray}}
\begin{lstlisting}
pub fn main() {
    let mut x = 5;
    x = call(x);
...
\lstset{language=Rust,caption={A deadlock!},label=endless-program, frame=none, stepnumber=5, backgroundcolor=\color{verylightgray}}
\begin{lstlisting}
use std::sync::{Arc, Mutex};
